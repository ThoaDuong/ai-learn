...
interface GroupManagementProps {
    ...
    onSetDefaultGroup: (id: string) => Promise<void>;
}
...
export default function GroupManagement({
    ...
    const handleSetDefault = async (id: string) => {
        ...
        setError("");
        try {
            await onSetDefaultGroup(id);
        } catch (err) {
            setError(err instanceof Error ? err.message : "Failed to set default group");
        } finally {
                                                                ...
                                                                {!group.isDefault && (
                                                                    <>
                                                                        <button
                                                                            ...
                                                                            className="p-1.5 rounded-lg hover:bg-yellow-100 text-gray-400 hover:text-yellow-600 transition-colors disabled:opacity-50"
                                                                            title="Set as Default"
                                                                        >
                                                                            {settingDefaultId === group._id ? (
